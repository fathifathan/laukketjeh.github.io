...
--
-- Host: 127.0.0.1
-- Generation Time: May 21, 2025 at 09:54 AM
...
--
-- Database: `lauk_ketjeh`
--
CREATE DATABASE IF NOT EXISTS `lauk_ketjeh` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `lauk_ketjeh`;
...
ALTER TABLE `order_item`
  ...
  ADD CONSTRAINT `order_item_ibfk_2` FOREIGN KEY (`id_menu`) REFERENCES `menu` (`id_menu`) ON DELETE CASCADE ON UPDATE CASCADE;
